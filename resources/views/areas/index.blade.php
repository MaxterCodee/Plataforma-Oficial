                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('areas.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="nombreCarrera"
                            ...
                            <div class="card shadow">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    {{-- <div class="ms-auto"> --}}
                                        ...
                                        <!-- Modal de edición -->
                                        <div class="modal fade" id="editModal_{{ $area->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{ route('areas.update', $area->id) }}"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nombreCarrera" class="form-label">Nombre del
                                                                    area</label>
                                                                <input type="text" value="{{ $area->name }}"
                                                                    class="form-control" name="name"
                                                                    id="nombreCarrera_{{ $area->id }}"
                                                                    placeholder="Ingrese el nombre de el Area"
                                                                    value="{{ $area->name }}">
                                                            </div>

                                                            <!-- Campo de carga de archivos -->
                                                            <div class="mb-3">
                                                                <label for="archivoCarrera"
                                                                    class="form-label">Descripción del area</label>
                                                                <textarea class="form-control" name="description"
                                                                    id="archivoCarrera_{{ $area->id }}"
                                                                    rows="3">{{ $area->description }}</textarea>
                                                            </div>
                                        ...
                                        <div class="modal fade" id="confirmModal_{{ $area->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ¿Estás seguro de que deseas eliminar el area "{{ $area->name
                                                        }}"?. <strong>Las carreras asignadas a un area perderan esa
                                                            asignación</strong>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <!-- Botón de cancelar -->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <button type="button" class="btn btn-invisible" data-bs-toggle="modal"
                                                data-bs-target="#editModal_{{ $area->id }}">
                                                <img src="{{ asset('storage/images/icons/wedit.svg') }}" width="35px"
                                                    class="me-2">
                                            </button>

                                            <button type="button" class="btn btn-invisible" data-bs-toggle="modal"
                                                data-bs-target="#areas_careers{{ $area->id }}">
                                                <img src="{{ asset('storage/images/icons/gteacher.svg') }}" width="35px"
                                                    class="me-2">
                                            </button>

                                            <!-- Botón eliminar carrera -->
                                            <button type="button" class="btn btn-invisible ms-2" data-bs-toggle="modal"
                                                data-bs-target="#confirmModal_{{ $area->id }}">
                                                <img src="{{ asset('storage/images/icons/wdelete.svg') }}" width="35px"
                                                    class="me-2">
                                            </button>
                                        </div>
