                ...
                <div class="card shadow">
                    <div class="card-body d-flex align-items-center">
                        ...
                        {{-- <div class="ms-auto"> --}}
                            ...
                            <!-- Modal de edición -->
                            <div class="modal fade" id="editModal_{{ $career->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('careers.update', $career->id) }}" method="post"
                                                ...
                                                <div class="mb-3">
                                                    <label for="nombreCarrera" class="form-label">Nombre de la
                                                        Carrera</label>
                                                    <input type="text" value="{{ $career->name }}" class="form-control"
                                                        name="name" id="nombreCarrera_{{ $career->id }}"
                                                ...
                                                <div class="mb-3">
                                                    <label for="archivoCarrera" class="form-label">Archivo de la
                                                        Carrera</label>
                                                    <input type="file" class="form-control" name="image_url"
                                                        id="archivoCarrera_{{ $career->id }}">
                                                </div>
                            ...
                            <div class="modal fade" id="confirmModal_{{ $career->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ¿Estás seguro de que deseas eliminar este programa de "{{ $career->name
