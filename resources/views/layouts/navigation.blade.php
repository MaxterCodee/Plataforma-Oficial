...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3 col-xl-2 bg-dark sidebar">
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark overflow-auto fixed-top">
                <!-- Agrega la clase 'fixed-top' aquí -->
                <h1></h1>
                <a href="/"
                    class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none"><br><br>
                    <img src="{{ asset('storage/images/icons/upq.svg') }}" width="65px" class="me-2"
                        alt="Imagen de menú">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item">
                            <a href="/" class="nav-link align-middle px-0">
                                <img src="{{ asset('storage/images/icons/home.svg') }}" width="25px" class="me-2"
                                    alt="Imagen de menú">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="#" style="color: rgb(255, 255, 255);">Inicio</a>
                        </li>
                        <li class="nav-item">
